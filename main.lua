...
function love.load()
  ...
  -- Rise of Caesar
  table.insert(events, Event:new( "Pompey & Crassus", "We can make you consul if you promise to pass all of our laws", "Accept", "Refuse", 0, 25, - 10, 0, - 25, 10))
  ...
  table.insert(events, Event:new( "", "Reform the tax system", "Yes", "No", 10, 0, 25, - 10, 0, - 25))
  table.insert(events, Event:new( "Metellus Cimber", "\"For the repealing of my banish'd brother?\"(3.1.34).", "Caesar allows his repeal.", "\"I must prevent thee, Cimber\"(3.1.34).", - 10, - 10, 0, 10, 10, 0))
